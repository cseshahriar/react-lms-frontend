                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    <div className="ms-3 mt-2">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <h4 className="mb-0">{rating.profile.full_name}</h4>
                                                                <span>{moment(rating.date).format("DD MMM, YYYY")}</span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div className="mt-2">
                                                            <span className="fs-6 me-1 align-top">
                                                                <Rater total={5} rating={rating.rating || 0} />
                                                            </span>
                                                            <span className="me-1">for</span>
                                                            <span className="h5">{rating.course?.title}</span>
                                                            <p className="mt-2">
                                                            ...
                                                            <p className="mt-2">
                                                                ...
                                                                {rating.reply || "No Reply"}
                                                            </p>
                                                            <p>
                                                                <button className="btn btn-outline-secondary" type="button" data-bs-toggle="collapse" data-bs-target={`#collapse${rating.id}`} aria-expanded="false" aria-controls={`collapse${rating.id}`}>
                                                                    Send Response
                                                                </button>
                                                            </p>
                                                            <div className="collapse" id={`collapse${rating.id}`}>
                                                                <div className="card card-body">
                                                                    <div>
                                                                        ...
                                                                        <button type="submit" className="btn btn-primary" onClick={() => handleSubmitReply(rating.id)}>
