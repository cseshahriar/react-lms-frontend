                                        ...
                                        <tbody>
                                            {courses?.map((course, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <p className="mt-3 badge bg-warning text-dark">{course.average_rating}</p>
                                                    </td>
                                                    <td>
                                                        <p className="mt-3">{moment(course.date).format("DD MMM, YYYY")}</p>
                                                    </td>
                                                    <td>
                                                        <Link to={`/instructor/edit-course/${course.course_id}/`} className="btn btn-primary btn-sm mt-3 me-1">
