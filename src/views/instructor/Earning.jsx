                            ...
                            <div className="card mb-4">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="dropdown dropstart">
                                        <a className="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="paymentDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div className="row">
                                        <div className="col-xl-6 col-lg-6 col-md-12 col-12 mb-3 mb-lg-0">
                                            <div className="border p-3 rounded shadow-sm">
                                                ...
                                                <h3 className="display-4 fw-bold mt-3 mb-0">${stats.total_revenue?.toFixed(2)}</h3>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-12 col-12 mb-3 mb-lg-0">
                                            <div className="border p-3 rounded shadow-sm">
                                                <i className="fe fe-shopping-cart icon-shape icon-sm rounded-3 bg-light-success text-dark-success mt-2" />
                                                <h3 className="display-4 fw-bold mt-3 mb-0">${stats.monthly_revenue?.toFixed(2)}</h3>
                            ...
                            <div className="card mb-4">
                                ...
                                <div className="table-responsive">
                                    <table className="table mb-0 text-nowrap table-hover table-centered text-nowrap">
                                        ...
                                        <tbody>
                                            {bestSellingCourse?.map((bestCourse, index) => (
                                                <tr key={index}>
                                                    <td>
                                                        <a href="#" className="text-decoration-none text-dark">
                                                            <div className="d-flex align-items-center">
                                                                <img
                                                                    src={"http://127.0.0.1:8000" + bestCourse.course_image}
                                                                    alt={bestCourse.course_title}
                                                                    style={{
                                                                        width: "100px",
                                                                        height: "70px",
                                                                        borderRadius: "50%",
                                                                ...
                                                                />
                                                                <h5 className="mb-0 ms-3 ">{bestCourse.course_title}</h5>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    <td>{bestCourse.sales}</td>
                                                    <td>${bestCourse.revenue}</td>
